How to contribute to Cozy Konnector Virgin Mobile
=================================================
...
- What is the version of the Cozy Konnector Virgin Mobile?
...
```
$ git clone github.com/cozy/cozy-konnector-virgin-mobile.git
$ cd cozy-konnector-virgin-mobile
$ git remote add fork git://github.com/yourusername/cozy-konnector-virgin-mobile.git
```
...
Go to https://github.com/yourusername/cozy-konnector-virgin-mobile and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy Konnector Virgin Mobile is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/cozy-konnector-virgin-mobile/issues/new
...
[localization]: https://github.com/cozy/cozy-konnector-virgin-mobile/blob/master/README.md#localization
