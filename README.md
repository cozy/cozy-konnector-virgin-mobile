[Cozy][cozy] Konnector Virgin Mobile
====================================
...
Download all your Virgin Mobile bills.
...
git://github.com/cozy/cozy-konnector-virgin-mobile.git#build
...
contributions from ZeHiro and nicofrand.
...
Cozy Konnector Virgin Mobile is developed by Cozy and distributed under the [AGPL v3 license][agpl-3.0].
